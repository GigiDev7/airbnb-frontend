...
const ModalLayout: React.FC<{
  ...
  return (
    <>
      ...
      <div className=" fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 h-3/4 bg-white rounded-xl flex flex-col items-center px-6 overflow-y-hidden">
        <AiOutlineClose
          onClick={closeModal}
